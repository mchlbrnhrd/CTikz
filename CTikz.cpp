                       ...
                       const std::string& f_legend_s)
{
  ...
  else
  {
    ...
    for (int l_k_i = 0; l_k_i < f_size_i; ++l_k_i) {
      std::pair<double, double> l_dataEntry_c = std::make_pair(*f_dataX_pd, *f_dataX_pd);
...
{
  std::string l_filenameTex_s = f_filenameTikz_s;
  l_filenameTex_s += ".latex.tex";
  ...
  std::string::size_type l_found_i = f_filenameTikz_s.rfind("/");
  std::string l_path_s ="./";
  ...
  std::cout << "path: " << l_path_s << std::endl;
  ...
  std::string l_filenameAux_s = f_filenameTikz_s;
  l_filenameAux_s += ".latex.aux";
  std::remove(l_filenameAux_s.c_str());
  
  std::string l_filenameLog_s = f_filenameTikz_s;
  l_filenameLog_s += ".latex.log";
